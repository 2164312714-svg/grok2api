  ...
  "zh-CN": {
    translation: {
      ...
      audits: {
        ...
        pricingCoverage: "可计费请求：已计价 {{priced}} · 待补价 {{unpriced}}",
        pricingDescription: "只统计成功且产生 token、图片或视频用量的请求；失败请求和零用量请求不计入未计价。",
        total: "总计",
        input: "输入",
        output: "输出",
  ...
  en: {
    translation: {
      ...
      audits: {
        ...
        pricingCoverage: "Billable: {{priced}} priced · {{unpriced}} missing rates",
        pricingDescription: "Only successful requests with token, image, or video usage are included; failed and zero-usage requests are excluded.",
        total: "Total",
        input: "Input",
        output: "Output",
        mediaInput: "Media Input",
...
Object.assign(resources["zh-CN"].translation.settings.routing as unknown as Record<string, string>, {
  selectionStrategy: "账号调度策略",
  selectionStrategyHelp: "均衡模式会分散请求；顺序模式会持续消耗前面的可用账号，满载或不可用时才向后展开。保存后立即生效。",
  selectionBalanced: "均衡分散",
  selectionSequential: "顺序吃号",
...
Object.assign(resources.en.translation.settings.routing as unknown as Record<string, string>, {
  ...
  selectionStrategyHelp: "Balanced spreads requests. Sequential keeps using the earliest available account and expands only when it is saturated or unavailable. Changes apply immediately.",
  selectionBalanced: "Balanced",
  selectionSequential: "Sequential",
