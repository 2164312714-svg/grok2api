...
func TestAuditRepositorySummaryAppliesRangeAndGroupsPricingTier(t *testing.T) {
	...
	values := []audit.Record{
		...
		{RequestID: "upstream-priced", ClientKeyID: 1, ModelRouteID: 1, ModelPublicID: "public", ModelUpstreamModel: "grok-build-0.1", StatusCode: 200, TotalTokens: 10, CostInUSDTicks: 50_000, DurationMS: 50, CreatedAt: now.Add(-90 * time.Minute)},
	...
	if summary.Requests != 3 || summary.SuccessfulRequests != 2 || summary.FailedRequests != 1 || summary.TotalTokens != 210_260 || summary.DurationMS != 450 {
		t.Fatalf("summary = %#v", summary)
	}
	if summary.EstimatedCostInUSDTicks != 1_840_000 || summary.PricedRequests != 2 || summary.UnpricedRequests != 0 || summary.PricedTokens != 160 || summary.UnpricedTokens != 0 {
